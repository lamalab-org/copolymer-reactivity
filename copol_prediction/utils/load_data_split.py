...
def print_split_info(split_dir="artifacts/data_splits"):
    ...
    print(
        f"Train samples:      {info['train_samples']} ({info['train_samples']/info['total_samples']*100:.1f}%)"
    )
    if "val_samples" in info:
        print(
            f"Validation samples: {info['val_samples']} ({info['val_samples']/info['total_samples']*100:.1f}%)"
        )
    print(
        f"Test samples:       {info['test_samples']} ({info['test_samples']/info['total_samples']*100:.1f}%)"
    )
