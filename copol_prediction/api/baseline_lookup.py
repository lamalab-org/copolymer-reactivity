...
def find_top_k_nearest_neighbors(
    ...
    if test_mon1_fp is None or test_mon2_fp is None or test_solv_fp is None:
        ...
        print(f"  Test SMILES in cache: m1={test_monomer1_smiles in fp_dict}, m2={test_monomer2_smiles in fp_dict}, s={test_solvent_smiles in fp_dict}")
    ...
    for rank, valid_idx in enumerate(top_k_valid_indices, start=1):
        ...
        result = {
            ...
            'reaction_id': str(train_row.get('reaction_id', '')) if pd.notna(train_row.get('reaction_id')) else None,
        }
