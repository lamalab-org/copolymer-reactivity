                ...
                for reaction in reactions:
                    ...
                    for monomer_pair in monomers:
                        ...
                        for condition in reaction_conditions:
                            ...
                            solvent_smiles = utils.name_to_smiles(
                                condition.get("solvent")
                            )
...
with open(
    "../data_extraction/data_extraction_GPT-4o/output/copol_database/copol_extracted_data_without_fp.json",
    "w",
) as file:
