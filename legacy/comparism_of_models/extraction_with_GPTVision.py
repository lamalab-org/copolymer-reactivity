...
#selected_entries_path = './data_extraction/enhanced_doi_list_unique.json'
...
for i, filename in enumerate(input_files):
    ...
    #file_path = os.path.join('./data_extraction', 'PDF', os.path.basename(filename))
    #file_path = os.path.join('./data_extraction/PDF', filename)
