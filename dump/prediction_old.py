...
def combine_csv_files(csv_files, output_file_combined):
    ...
    - output_file_combined: Path to the output_2 combined CSV file.
    """
    import pandas as pd
    ...
    # Save combined DataFrame to the output_2 file
...
def preprocess_data(
    ...
    if combine_data_files_flag:
        ...
        combined_csv_file = "../copol_prediction/output/combined_data.csv"
...
def main():
    ...
    # Pre modeling filter
    input_file_filter = "../copol_prediction/output/extracted_data_w_features_copol.json"
    output_file_filter = "../copol_prediction/output/all_data_filtered.json"

    # Pre-processing
    output_file_processing = "../copol_prediction/output/processed_data_copol.csv"

    # Model
    training_data = "./output_2/processed_data_copol.csv"
    training_data_flipped = "./output_2/processed_data_copol_flipped.csv"
    ...
    data_files_to_combine = [
        "./output_2/processed_data_copol.csv",
        "./output_2/processed_data.csv",
    ]
